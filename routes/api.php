...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    Route::get('/employees/{employeeId}', [PersonnelController::class, 'show']);
    Route::put('/employees/{employeeId}', [PersonnelController::class, 'update']);
    Route::delete('/employees/{employeeId}', [PersonnelController::class, 'destroy']);
